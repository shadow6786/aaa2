...
WHERE a.constraint_type ='FOREIGN KEY' AND a.table_schema = 'cms' AND a.table_name = '".$data['table']."'"."
...
WHERE non_unique = 1 AND index_type = 'FOREIGN KEY' AND table_schema = 'cms' AND table_name = '".$data['table']."'"."  
...
ORDER BY table_schema, table_name, constraint_name");
        ...
        } else if ($this->input->post('generate'))
            {
               ...
               ////////////////////
                $c_path = 'app/controllers/panel/'.$this->input->post('folder').'/';
                $m_path = 'app/models/panel/'.$this->input->post('folder').'/'; 
                $v_path = 'app/views/panel/'.$this->input->post('folder').'/';                              
                ...
                $l_search = array('{folder}','{controller_name_l}');
				
                $l_replace = array($this->input->post('folder'),$this->input->post('controller'));
