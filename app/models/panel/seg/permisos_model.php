...
class Permisos_model extends CI_model {
	...
	function add($data){
        $this->db->insert('seg_permisos', $data);
	...
	function edit($data,$fieldID,$ID){
        ...
        $this->db->update('seg_permisos', $data);
	...
	function get_permisos_combo($fields,$where='')
	{
		$this->db->select($fields);
		$this->db->from('seg_permisos');
		if($where)
	...
	function count(){
		return $this->db->count_all('seg_permisos');
	}
}