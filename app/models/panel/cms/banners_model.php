...
class Banners_model extends CI_model {
	...
	function add($data){
        $this->db->insert('cms_banners', $data);
	...
	function edit($data,$fieldID,$ID){
        ...
        $this->db->update('cms_banners', $data);
	...
	function get_banners_combo($fields,$where='')
	{
		$this->db->select($fields);
		$this->db->from('cms_banners');
		if($where)
	...
	function count(){
		return $this->db->count_all('cms_banners');
	}
}