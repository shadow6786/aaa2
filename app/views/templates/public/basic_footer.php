		...
		<div class="row sections">
			<div class="col-sm-4 recent_posts">
				...
				<div class="post">
					<a href="blogpost.html">
						<img src="<?php echo cdn_base("img/recent_post1.png"); ?>" class="img-circle" />
					</a>
					<div class="date">
						Wed, 12 Dec
					</div>
				...
				<div class="post">
					<a href="blogpost.html">
						<img src="<?php echo cdn_base("img/recent_post2.png"); ?>" class="img-circle" />
					</a>
					<div class="date">
						Mon, 12 Dec
					</div>
			...
			<div class="col-sm-4 testimonials">
				...
				<div class="wrapper">
					...
					<div class="author">
						<img src="<?php echo cdn_base("img/user-display.png"); ?>" />
